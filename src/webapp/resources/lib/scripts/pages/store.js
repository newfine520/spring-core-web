...
$("#btnStoreUserForWeekExport").on("click", function () {
    console.log(123456)
    $("#modalStoreUserExport").modal({ backdrop: 'static', keyboard: false });
})
...
$("#btnAdd").on("click", function () {
    ...
    if (StoreForm.valid()) {
        $.SubAjax({
            type: 'post',
            url: '/System/Store/AddStore?PromoterId=' + promoterId + '&SupervisorId=' + supervisorId,
...
$("#btnStoreUserExport").on("click", function () {
    $.SubAjax({
        type: 'post',
        url: '/System/Store/ExportStoreUser',
    ...
    $.SubAjax({
        ...
        success: function (data) {
            if (data.IsSuccess) {
                ...
                $("#SupplyForm").val(data.ProvideType);
                $("#StoreSubType").val(data.StoreSubType);
